                ...
                {gridData.map((grid, index) => (
                    <div key={index} className={styles.card}>
                        ...
                        <div className="flex flex-row align-items-center justify-content-center mt-2 mb-4">
                            <Link
                                className={`btn btn bg-transparent border-2 border-blue-400 text-blue-400 hover:border-blue-300 hover:text-blue-300 hover:bg-transparent`}
                                href="#waitlist"
                                onClick={() =>
                                    handleWaitlistButtonClick(grid.title)
                                }
                            >
                                Join Waitlist
                            </Link>
